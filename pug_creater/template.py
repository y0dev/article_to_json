...
lines.append(f'{fifth_level_body_idn}img.post-header-icon(src="{headshot}" alt="headshot")')
lines.append(f'{fifth_level_body_idn}p.post-header-time Thursday, October 6, 2022')
lines.append(f'{fifth_level_body_idn}span.post-header-divider |')
lines.append(f'{fifth_level_body_idn}button.post-header-shareButton#shareButton')
...
lines.append(f'{fifth_level_body_idn}a.post-link(href="{link}") text') # Add Link finder
lines.append(f'{fifth_level_body_idn}div.post-image-container')
lines.append(f'{sixth_level_body_idn}a.post-image-container(href="{link}") text')
lines.append(f'{seventh_level_body_idn}img.post-image(src="{post_image}" alt="post-image")')
...
lines.append(f'{fifth_level_body_idn}blockquote.post-quote(cite="") Blockquote')
